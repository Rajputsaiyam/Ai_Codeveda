...
//   // ✅ Save result to history after predictions
//   useEffect(() => {
...
//       history.unshift(newEntry); // add new entry at top
...
//                   className="flex-1 py-3 px-4 mt-2 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white flex items-center justify-center gap-2"
//                 >
...
//                   <button
//                     onClick={handleClear}
//                     className="flex-1 py-3 px-4 mt-2 rounded-lg bg-red-600 hover:bg-red-500 text-white flex items-center justify-center gap-2"
//                   >
...
//                   className="flex-1 py-3 px-4 mt-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white flex items-center justify-center gap-2"
//                 >
//                   History
//                 </button>
//               </div>
